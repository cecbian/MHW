...
%   Observed and simulated Marine Heatwaves (MHW)
%   statistics during 1982-2021. 

% Figure1 contain two section:
% contour:
%   Dataset: SourceDataFigure1_contour
%   Varb:
%       A: Result of Sateliate Observation (OISST)
%       B: Result of CESM-H
%       C: Result of CMIP6 ensemble mean
%       pos: postition setting of Figure1

% Bar:
%   Dataset: SourceDataFigure1_bar
...
% Section1: Contour ------------------------
clear; close all; 
load SourceDataFigure1_contour
